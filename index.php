...
<html lang="es">
    ...
    <body>
        ...
        <header id="header">
            ...
            <div class="logo">
                <h1><a href="index.html">LircayHub<span>.</span></a></h1>
            ...
            <nav id="navbar" class="navbar">
                ...
                <li><a class="nav-link scrollto" href="#">Frequently asked questions</a></li>

                <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
                <li><a class="getstarted scrollto" href="login.php">Ingresar</a></li>
                </ul>
